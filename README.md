...
- [simulations_heteroscedastic.R](simulations/simulations_heteroscedastic.R) and [simulations_high_noise.R](simulations/simulations_high_noise.R): # BASIL paper
...
- [sim_NegBin.R](simulations/sim_NegBin.R): data generated under negative binomial model
